...
class DeepSortFace(object):
    def __init__(self, model_path, max_dist=0.2, min_confidence=0.6, nms_max_overlap=0.9, max_iou_distance=0.7,
                 max_age=9000, n_init=5, nn_budget=100, use_cuda=True):
    ...
    def update(self, bbox_xywh, confidences, ori_img):
        ...
        outputs = []
        for track in self.tracker.tracks:  # a list
